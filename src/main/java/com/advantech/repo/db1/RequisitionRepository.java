...
public interface RequisitionRepository extends JpaRepository<Requisition, Integer>, DataTablesRepository<Requisition, Integer> {
    ...
    @EntityGraph(attributePaths = {"user", "user.floor", "user.unit", "requisitionState", "requisitionReason", "requisitionType", "requisitionFlow", "floor"})
    ...
    public List<Requisition> findAllByCreateDateGreaterThanAndRequisitionState_IdInAndFloor_IdIn(Date td, List<Integer> stateId, List<Integer> floorId);
