...
//                            //enduser use IE not support ws
        ...
        <script>
            ...
            function adjustRequisitionReason(funcTarget) {
                ...
                const order = ['2', '5', '6', '3'];
                const sortedOptions = $selector.find("option").sort((a, b) => order.indexOf(a.value) - order.indexOf(b.value));
            ...
            function selectorMtmEvent(funcTarget) {
                const $srcSelector = funcTarget.sel;
            ...
            function myModalFloorEvent(funcTarget) {
                ...
                $sel.on('change', function () {
                    ...
                    $selMesCustomTr.toggle(isM8);
                    $selMesTr.add($selFlowTr).toggle(!isM8);
                });
            }
        </script>
        <script>
                ...
                $("#myModal #save").click(function () {
                    ...
                    if (confirm("Confirm save?")) {
                        ...
                        var dataInput = {
                            ...
                            requisitionCateIms: {id: $modelTable.find("#requisitionCateIms\\.id").val()},
                            requisitionCateMes: {id: $modelTable.find("#requisitionCateMes\\.id").val()},
                        ...
                        if (!dataInput.requisitionCateMes.id) {
                            delete dataInput["requisitionCateMes"];
                            delete data["requisitionCateMes"];
                        }
